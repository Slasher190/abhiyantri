            ...
            <MDBCol lg="8" xl="6">
              <MDBCard className="border-top border-bottom border-3 border-color-custom">
                <MDBCardBody className="p-5">
                  <p className="lead fw-bold mb-5" style={{ color: '#31457a' }}>
                    Purchase Reciept
                  </p>
                  ...
                  <MDBRow className="my-4">
                    <MDBCol md="4" className="offset-md-8 col-lg-3 offset-lg-9">
                      <p className="lead fw-bold mb-0" style={{ color: '#212f56' }}>
                        £262.99
                      </p>
                    </MDBCol>
                  </MDBRow>

                  <p className="lead fw-bold mb-4 pb-2" style={{ color: '#31457a' }}>
                    Tracking Order
                  </p>
